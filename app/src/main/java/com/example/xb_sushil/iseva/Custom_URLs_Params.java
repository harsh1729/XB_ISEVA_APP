...
public class Custom_URLs_Params {
    ...
    public static HashMap<String, String> getParams_SaveCate(Context con,String name,String contact,String address,String servi,int imageid,int cityid,HashMap<Integer,Integer>images) {
    ...
    public static HashMap<String, String> getParams_RegisterUser(Context con, String name, String email, String number, String userName, String password, String promo) {
