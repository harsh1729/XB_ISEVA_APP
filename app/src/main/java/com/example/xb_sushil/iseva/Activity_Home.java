...
public class Activity_Home extends AppCompatActivity
    ...
    private void openDialog() {
        ...
        txtContent.setText(GCMIntentService.pushMessageText);
    ...
    private void sharePromocode() {
       // String shareBody = "Here is the share content body";
        ...
        sharingIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "Register iSeva app with promocode");
        sharingIntent.putExtra(android.content.Intent.EXTRA_TEXT, config.getPromoCode());
    ...
    private void downloadImag(String url) {
