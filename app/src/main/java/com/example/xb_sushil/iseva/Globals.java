...
public class Globals {
	...
	public final static String SHARE_LINK_GENERIC = "";

	public final static String SHARE_APP_MSG = "I found a new iSeva app at ";

	public static final String PNAME = "iSeva";
